/**
 * LinkedList represents a collection of nodes
...
public class LinkedList
{
	...
	/**
	 * removeFront removes the node at the beginning
	 * and returns its value. -1 is returned if it is empty.
	 * @return result int
	 */
	...
	/**
	 * removeBack removes the node at the beginning
	 * and returns its value. -1 is returned if the linked list is empty.
	 * @return result int
	 */
	 ...
	 * containing elements from head to lastElement.
	...
	/**
	 * toStringReverse returns the string containing elements
	 * from lastElement to head.
	 * @return string String
	 */
	...
	/**
	 * equals checks if the passed object is equal to the
	 * linked list. The two are equal if they are of the same
	...
	/**
	 * Node represents an element in LInkedList.
	 * Node contains the value and reference to the next node.
	 */
	public class Node
	{
		Node next;
