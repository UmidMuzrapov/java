/**
 *ArrayQueue represents a queue, where we remove the element 
 *from the front and add at the bottom --LIFO.
 *It uses DynamicArray for implementation.
 */
...
public class ArrayQueue implements QueueInterface
{
	...
	/**
	 * O(1)
	 * ArrayQueue() is an empty constructor.
	 */
	public ArrayQueue()
	{
	...
	/**
	 * O(n)
	 * ArrayQueue(ArrayQueue arrayQueueToCopy) is a copy constructor.
	...
	/**
	 * O(1)
	 * getData returns the dataField of the queue.
	 * @return DynamicArray
	 */
	...
	/**
	 * O(n)
	 * dequeue removes the front element and returns it.
	 * @return int
	 */
	public int dequeue()
	{
	...
	/**
	 * O(n)
	 * toString returns the string containing 
	...
	/**
	 * O(n)
	 * equals if the passed object is equal to the
	 * queue. The two objects are equal if they are of the same 
	 * type and each element matches.
	 * @param object
	 * @return
	 */
