...
/**
 * MyHashMap represents a data structure that maps keys to values. It implements HashTable.
 *
...
public class MyHashMap<K, V> {
  ...
  /**
   * The method prints out the map -- each slot, number of conflicts in each slot, and finally the
   * total# of conflicts.
   */
  ...
  /**
   * The method associated the given key with a value in the map. If the key exists, its value is
  ...
  /**
   * The method removes the given key and returns its associated value. If the key is not there,
   * null is returned.
   *
   * @param K key
   * @return value of type V
  ...
  /**
   * This Class represent the HashTable. It implements LinkedList and ArrayList. It can be used by
   * HashSet and HashMap.
   */
  private class HashTable<Key, Value> {
    ...
    /**
     * This method renders the ArrayList of size 8. Necessary to use the get method of the
     * ArrayList.
     */
    ...
    /**
     * The method prints out the hashTable -- each slot, number of conflicts in each slot, and
     * finally the total# of conflicts.
     */
    public void printTable() {
    ...
    /**
     * The method associated the given key with a value in the table. If the key exists, its value
    ...
    /**
     * The method removes the given key and returns if associated value. If the key is not there,
     * null is returned.
     *
     * @param key of type K
     * @return value of type V
  ...
  /**
   * This class represents a node in the linked list. Each entry store K and V data types.
   *
