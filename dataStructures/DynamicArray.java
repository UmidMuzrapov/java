/**
 * DynamicArray stores a collection of integers sequentially.
 * It uses int[] for implementation and resizes dynamically.
 */
...
public class DynamicArray
{
	...
	/**
	 * toString returns the string that contains the elements of
	 * the dynamic array.
	...
	/**
	 * equals checks if the given object is equal
	 * to the dynamic array. The two objects are equal
	 * if they are of the same type and each element matches.
	 * @param Object object
	 * @return boolean
	 */
	...
	/**
	 * adjustCapacity increases the capacity of
	 * dynamic array twice if the current capacity has filled up.
	 */
