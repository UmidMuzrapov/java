...
/**
 * The main class reads the filename and command,
 * processes the input file and creates a graph.
 * Based on the command, it solves traveling salesperson problem,
 * using one of the 4 methods.
...
public class PA11Main
{
	 ...
	 * If the file is not found, the program says so and stops.
	...
	/**
	 * This method performs the right operation on the graph 
	...
	/**
	 * This method opens the file, processes each line if
	 * it is not commented.
	...
	/**
	 * This method correctly processes the input line
	 * and store the well-formatted data in an array.
