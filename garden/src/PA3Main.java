 ...
 * PA3Main reads a file from the console,
 * processes the commands and performs them.
 * The main purpose of the code is to simulate a garden.
 */
...
public class PA3Main
{
	...
	/**
	 * getInformation reads the information from the file, parses it
	 * and formats it before adding it inputInformation ArrayList.
...
>	 */
	...
	/**
	 * getRawData reads the file and creates an ArrayList
	 * of String containing unedited commands.
	 * @param fileName String
	...
	/**
	 * getCommands is the command-parsing center.
	 * Based on the length of the command, it calls the right
			...
			switch(commandLength)
			{
				...
				default:
					System.out.println(String.join(" ", command)
							+ "is in the wrong format or does not exist.");
			}	
		}
	}
	...
	/**
	 * performCommands performs the valid commands.
	 * If the command is not supported, it says so.
	 * @param inputInformation ArrayList<String[]>
	 * @param rawData ArrayList<String>
	 * @param garden Garden
	 */
	static void performCommands(ArrayList<String[]> inputInformation,ArrayList<String> rawData, Garden garden)
	{
	...
	/**
	 * callRightPerformCommand calls the right method 
	...
	/**
	 * performLengthOneCommand performs
	 * the commands with a single argument, the verb.
	 * @param command String[]
	 * @param garden Garden
	 */
	...
	/**
	 * performLengthOneCommand performs
	 * the commands that have 2 arguments.
	 * @param command String[]
	 * @param garden Garden
	 */
	...
	/**
	 * performLengthOneCommand performs
	 * the commands that have three arguments.
	 * @param command String[]
	 * @param garden Garden
	 */
	...
	/**
	 * performLengthOneCommand performs
	 * the commands that have four arguments.
	 * @param command String[]
	 * @param garden Garden
	 */
	static void performLengthFourCommand(String[] command, Garden garden)
	{
		...
		if (commandAction.equals("GROW")) 
		{
			garden.growPlantInPlot(Integer.parseInt(command[1]),Integer.parseInt(command[2]),Integer.parseInt(command[3]));
		}
	 ...
	 * @return boolean
	 * true if none of the characters is not a digit.
	 */
	 ...
	 * @param stringToCheck String
	 * @return boolean
	 * true if each character is a digit.
	 */
	...
	/**
	 * checkNumColumns makes sure that a valid
	 * value for the column size is given.
	...
	{	
		if (isNumeric(numColumnsString))
		{
			...
			if (numColumns>16)
			{
				System.out.println("The system allows up 16 columns.\n "
		...
		{
			System.out.println("The value for column is not numeric or negative.\n"
					+ "Enter numeric value:");
	...
	/**
	 * checkNumRow makes sure that the valid
	 * value is given for the size of the garden raw.
	...
	static int checkNumRows(String numRowsString)
	{
		...
		{
			System.out.println("The value for row is not numeric or negative.\n"
					+ "Enter numeric value:");
	...
	/**
	 * getRemoveList gives a list of remove methods
	 * -- Harvest, Cut, Pick.
	...
	/**
	 * getRemoveMap maps the remove verb 
	 * to plant type.
	...
	/**
	 * getPossibleCommands gives possible commands this
	 * code can do.
	...
	/**
	 * buildGarden builds a garden after 
	 * validating the given size of it.
	 * @param inputInformation ArrayList<String[]>
