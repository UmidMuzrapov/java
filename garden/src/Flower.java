/**
 * @author: Umid Muzrapov Flower class inherits from abstract Plant class. It represent a flower.
 */
public class Flower extends Plant {
  ...
  /**
   * grow makes the tree to bloom specified number of times. It does so by calling a recursive
   * function.
   *
  ...
  /**
   * recursivleyGrow makes the flower blossom, filling the bordering empty cells recursively.
   *
   * @param rowNumber int
   * @param colNumber int
   * @param timesToGrow int
  ...
  /**
   * indexOK makes sure that given rowNumber and colNumber are within range.
   *
   * @param rowNumber int
   * @param colNumber int
