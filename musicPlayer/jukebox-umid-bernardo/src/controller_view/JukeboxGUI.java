...
public class JukeboxGUI extends Application {
  ...
  public void start(Stage primaryStage) throws Exception {
    ...
    primaryStage.setOnCloseRequest(
        (e) -> {
          if (currentUser != null) saveChanges();
        });
  }
  ...
  private void createFuncPanePlayList() {
    ...
    pauseButton.setOnAction(
        (e) -> {
          if (isLoggedIn) {
            model.pause();
          } else showWarning("Please log in.");
        });
  ...
  private StackPane createNewSongIntake() {
    ...
    intakeInfo
        .getChildren()
        .addAll(titleLabel, titleText, artistLabel, artistText, urlLabel, urlText);
