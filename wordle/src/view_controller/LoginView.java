...
/**
 * This class represents the view for the login screen of the application. It extends the GridPane
 * class.
 */
public class LoginView extends GridPane {
  ...
  /**
   * Handles the login button click event. It checks the entered username and password and performs
  ...
  /**
   * Handles the create account button click event. It creates a new account using the entered
