...
/**
 * @author UBIS This class is an observable class to notify observers of any state change in the the
 *     observable. The observable class must extend this class MyObserverable.
 */
