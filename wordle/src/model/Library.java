...
/**
 * This class represents the dictionary of words of length 5.
 *
 * @author UBIS
 */
public class Library implements Serializable {
  ...
  /**
   * The constructor makes the library by opening a file that contains all the words of length 5 and
   * storing them in a map. The reason we are storing in a map is because it makes looking for a
   * word more time efficient (especially since there's a lot of words)
   */
  public Library() {
    try {
   ...
   * @return a boolean indicating if the attempt exists in the library
   */
