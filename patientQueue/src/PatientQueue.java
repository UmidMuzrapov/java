...
/**
 * This class represent a PatientQueue, where patients with a lower priority
...
public class PatientQueue {
	...
	/**
	 * This method adds a new patient in the queue based on their priority. If the
	 * priorities are the same, the the person's name will decide priority.
	 * 
	...
	/**
	 * The method removes the patient at the front of the queue. Exception is thrown
	...
	/**
	 * This method returns the priority of the frontmost patient without removing
	 * them.
	 * 
	...
	/**
	 * This method changes the priority of the given patient. If the name is not in
...
class MyHeap {
	...
	/**
	 * This method throw an exception if the queue is empty when patient need to be
	 * removed or peeked.
	 */
	...
	/**
	 * this one positions the patient in the right order based on their new
	 * priority.
	 * 
